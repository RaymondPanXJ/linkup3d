...
(function (root, factory) {
  ...
  function c2() {
    var expect = [
      ['冷眠醒转', 4, 4, 8, 0, 35, null],
      ['微光航道', 4, 6, 12, 180, 55, null],
      ['霜纹初现', 4, 6, 12, 180, 60, null],
      ['巡猎初鸣', 4, 6, 12, 240, 90, [25000, 3000]],
      ['冰湖', 4, 6, 12, 240, 90, [20000, 3000]],
      ['双子冰缝', 6, 8, 24, 300, 120, null],
      ['极夜', 6, 8, 24, 360, 145, [30000, 3000]],
      ['白毛风', 6, 8, 24, 360, 155, [22000, 3000]],
      ['冰下回声', 6, 8, 24, 420, 180, [18000, 3000]],
      ['星核之眼', 6, 8, 24, 480, 205, [18000, 2500]]
    ];
    var bad = '';
