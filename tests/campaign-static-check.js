...
function runChecks() {
  ...
  var baseline = [
    [0, '冷眠醒转', 4, 4, 8, 0, 35, 0, null],
    [1, '微光航道', 4, 6, 12, 180, 55, 0, null],
    [2, '霜纹初现', 4, 6, 12, 180, 60, 2, null],
    [3, '巡猎初鸣', 4, 6, 12, 240, 90, 0, [25000, 3000]],
    [4, '冰湖', 4, 6, 12, 240, 90, 0, [20000, 3000]],
    [5, '双子冰缝', 6, 8, 24, 300, 120, 4, null],
    [6, '极夜', 6, 8, 24, 360, 145, 0, [30000, 3000]],
    [7, '白毛风', 6, 8, 24, 360, 155, 0, [22000, 3000]],
    [8, '冰下回声', 6, 8, 24, 420, 180, 2, [18000, 3000]],
    [9, '星核之眼', 6, 8, 24, 480, 205, 0, [18000, 2500]]
  ];
  var mismatch = '';
